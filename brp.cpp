...
int main(int argc, char *argv[])
{
   ...
   { 
        ...
        a.AddInteriorFaceIntegrator(new DGDiffusionIntegrator(r,
                                                              sigma, kappa));
        // Counteract the n.Grad(u) term on the Dirichlet portion of the boundary
        a.AddBdrFaceIntegrator(new DGDiffusionIntegrator(r, sigma, kappa),
                             dbc_bdr);
   }
   a.Assemble();
   ...
   if (h1)
   {
        ...
        u.ProjectBdrCoefficient(g3,dbc_bdr);
    ...
    else 
    {
        ...
        b.AddBdrFaceIntegrator(new DGDirichletLFIntegrator(dbcCoef, r,
                                                            sigma, kappa), dbc_bdr);
